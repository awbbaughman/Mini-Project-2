...
const App = () => {
  ...
  const [displayAbilities, setDisplayAbilities] = useState(false); //state says no ability selected immediately
...
<h1>Welcome to the Lo-Fi Overwatch Practice Range!</h1>
  <HeroCards heroes={heroes} onHeroSelect={handleHeroSelect} />

    <div id="practiceRange"> {/* this is where I intended to have the hero abilities appear as cards after selecting a specific hero! */}
